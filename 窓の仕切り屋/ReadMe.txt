========================================================================
    Win32 アプリケーション: 窓の仕切り屋 プロジェクトの概要
========================================================================

この 窓の仕切り屋 アプリケーションは、AppWizard により作成されました。
...
窓の仕切り屋.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル 窓の仕切り屋.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル 窓の仕切り屋.rc 
    にインクルードされます。
